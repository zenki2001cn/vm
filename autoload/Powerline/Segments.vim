" add zenki, add "ascii" and "total line"
let g:Powerline#Segments#segments = Pl#Segment#Init(
	...
	\ Pl#Segment#Create('ascii'   , '%03.3b,0x%02.2B'),
	\ Pl#Segment#Create('scrollpercent'   ,
		\ Pl#Segment#Create('scrollpercent.percent'    , '%3p%%'),
		\ Pl#Segment#Create('scrollpercent.total'    , '%L'),
    \),

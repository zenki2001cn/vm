...
hi Marks term=reverse ctermfg=0 ctermbg=7 guibg=Grey40
...
" " map these in .vimrc by zenki
" nmap <silent> <F9> :call HLMarks("Marks")<CR>
" nmap <silent> <F10> :call clearmatches()<CR>
" nmap <silent> <S-F9> :call clearmatches()\|:delmarks a-z<CR>
" nmap <silent> <F11> :call AddHLMark("Marks")<CR>
" nmap <silent> <S-F11> :call DelHLMark("Marks")<CR>
